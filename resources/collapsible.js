...
for (let i = 0; i < posts.length; i++) {
  posts[i].addEventListener("click", function() {
    ...
    this.parentNode.parentNode.classList.toggle("collapsed-parent");
  });
}
...
for (let i = 0; i < posts.length; i++) {
  posts[i].addEventListener("click", function() {
    this.classList.toggle("collapsed-thread");
    this.parentNode.classList.toggle("collapsed-thread-parent");
  });
}
